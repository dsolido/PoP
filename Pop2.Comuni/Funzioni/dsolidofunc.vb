#Disable Warning BC40056 ' Lo spazio dei nomi o il tipo specificato nelle istruzioni Imports 'MySql.Data.MySqlClient' non contiene membri pubblici o non è definito. Accertarsi che lo spazio dei nomi o il tipo sia definito e contenga almeno un membro pubblico e che il nome dell'elemento importato non usi alias.
Imports MySql.Data.MySqlClient
#Enable Warning BC40056 ' Lo spazio dei nomi o il tipo specificato nelle istruzioni Imports 'MySql.Data.MySqlClient' non contiene membri pubblici o non è definito. Accertarsi che lo spazio dei nomi o il tipo sia definito e contenga almeno un membro pubblico e che il nome dell'elemento importato non usi alias.
...
Public Module dsolidofunc

    Public Function ritornainiziofinemese(ByVal Periodo As DateTime) As Array
        Dim a(1) As Date
    ...
    Public Structure ConteggioTotaleAssenze
        ...
        End Sub
    End Structure
    Public Function Array_search(ByVal key As Integer, ByVal mioArray As Integer()) As Integer
        Dim i As Integer
    ...
    Public Function EliminaCaratteriSpeciali(ByRef Testo As String, Optional SenzaSpazi As Boolean = False) As String
        ...
        Return Valore
    End Function
    Public Function TryDecimale(ByVal obj As String) As Decimal
        Dim resp As Decimal
        Dim v = Decimal.TryParse(obj, resp)
        Return resp
    End Function

    Public Function Array_push(arr, vars)
        ...
        End If
    End Function
    Public Function Propper(input As String) As String
        ...
        End If
    End Function
    Public Function G_CambiaColore(Optional LBTMP As Object = Nothing) As Task
        Select Case True
    ...
    End Function
    Public Function ProperCase(ByVal Testo As String) As String
        ...
        Return sb.ToString()
    End Function
    Public Function controlla_form_aperto(ByVal form As Form)
        Dim oForm As Form
        ...
        Return (attivo)
    End Function
    Public Function MSGButton(ByVal attendi As Boolean, ByRef Tasto As ToolStripButton, ByVal Optional messaggio As String = "", Optional visibile As Boolean = Nothing)
        ...
        Return Tasto
    End Function
    Public Function PausaperVisualizzazione(ByVal Optional tempo As Integer = 1)    'refresh dello schermo
        System.Windows.Forms.Application.DoEvents()
        Thread.Sleep(tempo)
        Return True
    End Function

    Public Function legge_informazioni(nome_app As String, nome_utente As String) As DataRow
        ...
        End Using
    End Function
    Public Function memorizza_informazioni(nome_app As String, numero_riga As Integer, nome_utente As String, nome_ri As Array) As Boolean
        Try
...
#Enable Warning CA1031 ' Non rilevare tipi di eccezione generali
    ...
    Public Function ritorna_mese(n_mese As Integer)
    ...
    End Function
    Public Function ConvertToTime(value As String) As TimeSpan
        ...
        End Try
    End Function
    Public Function TtoD(value As TimeSpan) As DateTime
        'Dim convertedDate As TimeSpan
        Dim S_tmp As String
    ...
    Public Function DataMysql(value As DateTime) As String
        Dim S_tmp As String
        S_tmp = value.Year.ToString & "/" & value.Month.ToString & "/" & value.Day.ToString
        Return (S_tmp)
    End Function
    Public Function CambiaColore(Optional LBTMP As Label = Nothing, Optional TX As TextBox = Nothing, Optional TTX As ToolStripTextBox = Nothing)
        Select Case True
    ...
    End Function
    Public Function GenerateFileMD5(ByVal filePath As String)
...
#Enable Warning CA1031 ' Non rilevare tipi di eccezione generali
    ...
    '
    '
    Public Function NewDToremese() As DataTable 'Crea una DT e la popola con i valori passati dal bindingsource
        Dim Ute As DataTable = New DataTable
        Ute.Namespace = "TABtmpUte"
#Disable Warning BC42024 ' Variabile locale inutilizzata: 'CliRow'.
        Dim CliRow As DataRow
#Enable Warning BC42024 ' Variabile locale inutilizzata: 'CliRow'.
        ...
        Return Ute
    End Function
    Public Function NewDToremeseCliente() As DataTable 'Crea una DT e la popola con i valori passati dal Datatable
...
#Enable Warning BC42024 ' Variabile locale inutilizzata: 'CliRow'.
    ...
    '
    Public Function CaricaDatiOreDipendente(ByRef cli As DataTable, ByRef bstmp As BindingSource)
        ...
        Return cli
    End Function
    Public Function CaricaDatiOreCliente(ByRef cli As DataTable, ByRef bsTmp As BindingSource)
    ...
    'chiamata da frmDipendentiFerie
    '
    Public Function CaricaDettagliSostituzioni(ByRef DT As DataTable, ByVal dtSost As DataTable) As DataTable
    ...
    '
    Public Function CalcolaOraridaContrattoDipendenti(ByRef Cli As DataTable, ByRef bs As BindingSource) As DataTable
    ...
    '
    Public Function OrdinaTabella(ByVal tabella As DataTable, ByVal Campo As String) As DataTable
    ...
    '
    Public Function AssegnaTotaleOreperGiornoSettimana(ByVal dt As DataTable, ByVal Giorno As DateTime, ByVal idDes As Integer) As Decimal
