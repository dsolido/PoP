Public Class FRM_STP_OreClienti
    ...
    Private Sub FRM_stp_OreDipendenti_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.RP_programmaperCliente.RefreshReport()
    End Sub

    Private Sub ReportViewer1_Load(sender As Object, e As EventArgs) Handles RP_programmaperCliente.Load
